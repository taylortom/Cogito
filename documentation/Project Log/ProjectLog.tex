...
\paragraph{} I also changed the inheritance heirarchy to make more sense. It is now:
...
\paragraph{} I also added a lot of code for the Q-learning and created a \emph{State}
